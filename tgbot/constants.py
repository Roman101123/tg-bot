...
TXT_START = "id; chat_id; name; username; height; weight; age; born_date; gender; level_of_activities; end_message; register_datetime; register_date"
JSON_KEYS = ["id", "chat_id", "name", "username", "height", "weight", "age", "born_date", "gender", "level_of_activities", "end_message", "register_datetime", "register_date"]
